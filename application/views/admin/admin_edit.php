            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="staffdetail" name="staffdetail"  rows="5" required><?php echo $results->staffdetail; ?></textarea>
                </div>
              </div>
            </div>
            <br>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input class="form-control" type="file" id="staffpic" name="staffpic" required>
                </div>
              </div>
            </div>
            <br>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <select class="form-select" id="recipient" name="recipient" required>
                    ...
                    <option value="กองสาธารณะสุข">กองสาธารณสุขฯ</option>
                    <option value="งานป้องกัน">งานป้องกัน</option>
                    <option value="กองคลัง">สำนักคลัง</option>
                    <option value="กองยุทธศาสตร์">กองยุทธศาสตร์ฯ</option>
